-- Fixed Migration Script for Appointment Scheduler
-- This version doesn't reference owner_id column
...
-- 7. Create indexes (only ones that don't reference missing columns)
...
-- Done! Your appointment scheduler should now work properly.